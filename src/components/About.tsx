    ...
    <div>
        ...
        {images.map((image, index) => (
          <motion.div
            ...
            <Image
              ...
              height={400}
              alt="about"
              className="rounded-lg object-cover transform rotate-3 shadow-xl block w-full h-40 md:h-60 hover:rotate-0 transition duration-200"
            />
          </motion.div>
        ))}
        {/* 
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          Hey there, I&apos;m Hnin Thiri San - a passionate Data Scientist, avid writer,
        ...
        <Paragraph className=" mt-4">
          ...
          art of crafting exceptional digital experiences. As a Data Scientist, I
          thrive on turning lines of code into functional and elegant solutions.
          My goal is to not just create AI Model, but to build digital marvels
          that seamlessly merge something that people called impossible and reality.
        </Paragraph>
        ...
        <Paragraph className=" mt-4">
          What sets me apart is my unwavering appreciation for maths. I believe
          that linear algebra and stastics go hand in hand. My taste for solving
          problems ensures that every project I undertake not only works
        ...
        <Paragraph className=" mt-4">
          ...
          who appreciates the finer aspects of AI models, there&apos;s something
          here for you.
        </Paragraph>
        <Paragraph className=" mt-4">
          ...
          of technology, all while reveling in the sheer beauty
          of thoughtful presentation.
        </Paragraph>
        <Paragraph className=" mt-4">
